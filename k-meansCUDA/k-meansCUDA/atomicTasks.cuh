...
cudaError_t countKMeansAtomic(const uint32_t iterations, const uint32_t dataSize, value_t* data, const uint32_t meansSize, value_t* means, uint32_t* assignedClusters, uint64_t dimension, std::string version = "");
